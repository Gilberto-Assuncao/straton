...
export type KpiIcon = "clock" | "users" | "approval" | "locations";
export type TimesheetStatus = "Approved" | "Pending" | "Rejected";
export type TeamActivityType = "shift_started" | "timesheet_submitted" | "location_updated" | "timesheet_approved";
...
export type RecentTimesheet = { id: string; employee: string; location: string; hours: number; date: string; status: TimesheetStatus };
