import type { ReactNode } from "react"; import { Badge } from "@/src/components/data-display"; import { Icon } from "@/src/components/ui";
 ...
 */
export function GpsBadge({ label }: { label:string }) { return <Badge tone="info">{label}</Badge>; }
