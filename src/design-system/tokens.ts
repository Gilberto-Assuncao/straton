...
export const componentClasses = { focus: "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand", control: "min-h-11 rounded-lg border border-white/10 bg-surface-alt px-4 text-base text-ink outline-none placeholder:text-ink-subtle focus:border-brand focus:ring-2 focus:ring-brand/20 disabled:cursor-not-allowed disabled:opacity-50", surface: "rounded-2xl border border-white/10 bg-surface" } as const;
