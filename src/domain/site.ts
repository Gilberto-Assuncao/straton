...
export interface Site { id: SiteId; name: string; clientId: string; operatingCompanyId: CompanyId; address: Address; coordinates?: GeoCoordinates; reference?: string; purchaseOrderNumber?: string; costCenter?: string; managerId: UserId; schedule: DateRange; status: SiteStatus }
