...
export default async function DashboardPage() {
  const [{ user }, { kpis, weeklyHours, teamActivities, recentTimesheets }, livePoints, roleOverview, t] = await Promise.all([
  ...
  return (
    <section aria-labelledby="dashboard-heading">
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-[1.6fr_1fr]"><WeeklyHoursChart data={weeklyHours} /><LiveMapPreview points={livePoints} /></div>
