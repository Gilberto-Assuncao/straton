...
export default async function EmployeesPage() {
  ...
  const statCards = [
    { label: t("statActiveTeams"), value: teamNames.length, color: "text-[#4ADE80]", border: "border-white/10" },
    { label: t("statTotalEmployees"), value: employees.length, color: "text-[#E5E7EB]", border: "border-white/10" },
    { label: t("statActive"), value: active, color: "text-[#4ADE80]", border: "border-white/10" },
