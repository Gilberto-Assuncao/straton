...
export default async function TimesheetsPage() {
  const [{ timesheet, employees, projects, weekRanges }, pending, { session }, t] = await Promise.all([
    ...
    <section aria-labelledby="timesheets-heading">
      ...
      */}
      <div className="mt-8 grid gap-5">
        ...
        <TimesheetPage timesheet={timesheet} employees={employees} projects={projects} weekRanges={weekRanges} />
      </div>
    </section>
  );
}
