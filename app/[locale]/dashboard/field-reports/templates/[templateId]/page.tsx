...
export default async function TemplateDetailPage({
  ...
  return (
    <section aria-labelledby="template-heading">
      <Link href="/dashboard/field-reports/templates" className="inline-flex min-h-11 items-center text-sm font-semibold text-[#9CA3AF] hover:text-[#E5E7EB] focus-visible:outline-2 focus-visible:outline-[#22C55E]">← {t("backToTemplates")}</Link>
