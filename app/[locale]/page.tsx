...
export default async function Home() {
  ...
  return (
    <div className={`${styles.page} min-h-screen bg-canvas text-ink-bright`}>
      {/* Fixed top navbar */}
      <header className="sticky top-0 z-50 border-b border-edge-10 bg-canvas/85 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5 sm:px-10">
          ...
          <details className="group md:hidden">
            <summary className="flex min-h-11 min-w-11 cursor-pointer list-none items-center justify-center rounded-lg border border-edge-15 text-ink-bright [&::-webkit-details-marker]:hidden">
            ...
            <div className="absolute left-5 right-5 top-[64px] overflow-hidden rounded-2xl border border-edge-10 bg-surface-deep p-3 shadow-2xl shadow-black/40">
              <nav className="grid">
                <a href="#funcionalidades" className="rounded-lg px-3 py-2.5 text-sm font-medium text-ink-dim hover:bg-edge-5 hover:text-white">{t("nav.features")}</a>
                <a href="#georreferenciamento" className="rounded-lg px-3 py-2.5 text-sm font-medium text-ink-dim hover:bg-edge-5 hover:text-white">{t("nav.geolocation")}</a>
                <a href="#painel" className="rounded-lg px-3 py-2.5 text-sm font-medium text-ink-dim hover:bg-edge-5 hover:text-white">{t("nav.dashboard")}</a>
                <a href="#cadeia" className="rounded-lg px-3 py-2.5 text-sm font-medium text-ink-dim hover:bg-edge-5 hover:text-white">{t("nav.chain")}</a>
              </nav>
              <div className="mt-3 grid grid-cols-2 gap-2 border-t border-edge-10 pt-3">
                <Link href="/login" className="inline-flex min-h-11 items-center justify-center rounded-lg border border-edge-15 px-3 text-sm font-semibold text-ink-bright">{t("nav.login")}</Link>
      ...
      <section className={`${styles.heroBg} overflow-hidden px-6 pb-28 pt-24 sm:px-10`}>
        ...
        <div className="relative mx-auto grid max-w-6xl gap-14 lg:grid-cols-2 lg:items-center">
          ...
          <div className={`${styles.floatCard} relative rounded-2xl border border-edge-10 bg-surface-deep/80 p-6 shadow-2xl shadow-black/40 backdrop-blur`}>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 sm:px-10">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          ...
          <div className={`${styles.floatCard} rounded-2xl border border-edge-10 bg-surface-deep/80 p-7 shadow-2xl shadow-black/40 backdrop-blur`}>
            <div className="flex items-center justify-between">
      ...
      <section id="painel" className="scroll-mt-24 mx-auto max-w-6xl px-6 py-24 sm:px-10">
        ...
        <div className={`${styles.floatCard} overflow-hidden rounded-2xl border border-edge-10 bg-surface-deep shadow-2xl shadow-black/50`}>
          ...
          <div className={`${styles.mapGrid} relative h-80 overflow-hidden rounded-2xl border border-edge-10 bg-[#0a1120]`}>
            ...
            {workSites.map((site) => (
              <div key={site.name} className="group absolute -translate-x-1/2 -translate-y-1/2" style={{ top: site.top, left: site.left }}>
                ...
                <div className="pointer-events-none absolute left-5 top-full mt-2 w-max max-w-[220px] rounded-md border border-edge-10 bg-surface-inset px-3 py-2 text-xs text-ink-bright opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100">
      ...
      <section id="cadeia" className="scroll-mt-24 border-y border-edge-10 bg-surface-deep/40">
        <div className="mx-auto max-w-6xl px-6 py-24 sm:px-10">
          ...
          <ol className="mt-16 grid gap-6 md:grid-cols-3">
            {["one", "two", "three"].map((step, index) => (
              <li key={step} className="relative rounded-2xl border border-edge-10 bg-canvas p-7">
          ...
          <div className="mt-10 rounded-2xl border border-edge-10 bg-canvas p-7 sm:p-9">
            <div className="flex flex-col items-stretch gap-4 lg:flex-row lg:items-center">
              ...
              <div className="flex-1 rounded-xl border border-edge-15 bg-surface-inset p-5 text-center">
            ...
            <p className="mt-7 border-t border-edge-10 pt-6 text-sm leading-7 text-ink-dim">
      ...
      {/* Capability grid */}
      <section className="border-y border-edge-10 bg-surface-deep/40">
        <div className="mx-auto max-w-6xl px-6 py-24 sm:px-10">
          <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {(["card1", "card2", "card3", "card4", "card5", "card6"] as const).map((cardKey, index) => {
              ...
              return (
                <div key={cardKey} className="rounded-2xl border border-edge-10 bg-surface-deep/80 p-6">
      ...
      <section className="scroll-mt-24 mx-auto max-w-6xl px-6 py-24 text-center sm:px-10">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
          ...
          <a href={`mailto:${SUPPORT_EMAIL}`} className="inline-flex min-h-14 items-center rounded-lg border border-edge-15 px-7 text-base font-semibold text-ink-bright transition hover:bg-edge-5">{t("finalCta.ctaSecondary")}</a>
        </div>
      </section>
...
function PhoneMock({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="h-72 w-40 rounded-[2rem] border-4 border-edge-10 bg-surface-deep p-3 shadow-2xl shadow-black/40">
