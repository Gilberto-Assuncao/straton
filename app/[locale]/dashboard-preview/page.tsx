          ...
          <div className="grid grid-cols-[260px_1fr]">
            <aside className="flex min-h-[calc(100vh-60px)] flex-col border-r border-edge-10 bg-surface-deep px-[16px] py-6">
              ...
              <nav className="flex flex-1 flex-col gap-5">
                <div>
                  <div className="mb-2 px-3 text-[10.5px] font-bold uppercase tracking-wide text-ink-dim">Geral</div>
                ...
                {showApprovals ? (
                  <div>
                    <div className="mb-2 px-3 text-[10.5px] font-bold uppercase tracking-wide text-ink-dim">Operações</div>
                    <div className="flex flex-col gap-0.5">
                ...
                {showPayroll ? (
                  <div>
                    <div className="mb-2 px-3 text-[10.5px] font-bold uppercase tracking-wide text-ink-dim">Financeiro</div>
                    <div className="flex flex-col gap-0.5">
                ...
                {showAdminHealth ? (
                  <div>
                    <div className="mb-2 px-3 text-[10.5px] font-bold uppercase tracking-wide text-ink-dim">Empresa</div>
                    <div className="flex flex-col gap-0.5">
                    ...
                    {visibleKpis.map((kpi) => (
                      <div key={kpi.label} className={`rounded-2xl border ${kpi.border} bg-surface-deep p-5.5 transition hover:-translate-y-0.5 hover:border-brand/35`}>
                        ...
                        <div className="mt-2.5 flex items-center justify-between">
                          <a href="#" className="text-[13px] font-semibold text-brand-bright hover:text-brand-bright">{kpi.cta} →</a>
                    ...
                    <div className="flex flex-col gap-2.5">
                      {visibleAttention.map((item) => (
                        <div key={item.text} className="flex items-center justify-between rounded-[10px] bg-surface-inset py-3.5 pl-4 pr-4 transition hover:bg-[#152040]" style={{ borderLeft: `3px solid ${item.accent}` }}>
                          ...
                          <a href="#" className="whitespace-nowrap text-[13px] font-semibold text-brand-bright hover:text-brand-bright">{item.cta} →</a>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="overflow-hidden rounded-2xl border border-edge-10 bg-surface-deep">
                    ...
                    {visibleRows.map((row) => (
                      <div key={row.name} className={`grid grid-cols-[1.6fr_1.2fr_1fr_1.2fr_1fr] items-center border-t border-edge-5 px-6 py-4 transition hover:bg-surface-inset ${support ? "opacity-70" : ""}`}>
                        ...
                        {support ? (
                          <span className="text-[13px] text-ink-dim">bloqueado</span>
                        ) : (
