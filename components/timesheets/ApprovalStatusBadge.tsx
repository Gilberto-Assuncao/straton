...
const statusConfig: Record<ApprovalStatus, { key: string; icon: string; style: string }> = { draft: { key: "statusDraft", icon: "○", style: "bg-edge-8 text-ink-soft" }, submitted: { key: "statusSubmitted", icon: "↑", style: "bg-blue-400/10 text-info" }, approved: { key: "statusApproved", icon: "✓", style: "bg-brand/10 text-brand-bright" }, rejected: { key: "statusRejected", icon: "!", style: "bg-red-400/10 text-danger-soft" } };
