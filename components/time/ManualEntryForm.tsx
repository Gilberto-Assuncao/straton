...
const inputClass = "min-h-11 w-full rounded-xl border border-white/10 bg-surface-alt px-3 text-sm text-ink outline-none transition [color-scheme:dark] focus:border-brand focus:ring-2 focus:ring-brand/20";
