    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          minLength={8}
          {...props}
          className="min-h-12 w-full rounded-lg border border-white/15 bg-surface-alt py-3 pl-4 pr-14 text-base text-ink outline-none transition placeholder:text-ink-subtle hover:border-white/25 focus:border-brand focus:ring-2 focus:ring-brand/20 user-invalid:border-red-400 user-invalid:ring-2 user-invalid:ring-red-400/15"
        />
        <button
          type="button"
          ...
          className="absolute right-1 top-1/2 flex min-h-11 min-w-11 -translate-y-1/2 items-center justify-center rounded-md text-ink-muted transition hover:bg-white/5 hover:text-ink focus-visible:outline-2 focus-visible:outline-brand"
        >
