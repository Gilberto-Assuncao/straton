...
const styles: Record<TimesheetStatus, string> = { Approved: "bg-brand/10 text-brand-bright", Pending: "bg-amber-400/10 text-amber-300", Rejected: "bg-red-400/10 text-red-300" };
