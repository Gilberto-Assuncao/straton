...
export default function KpiCard({ kpi }: { kpi: DashboardKpi }) {
  ...
  return (
    <article className={`group rounded-2xl border ${borderStyles[kpi.state]} bg-[#161A34] p-5 transition duration-300 hover:-translate-y-0.5 hover:border-white/20 hover:shadow-xl hover:shadow-black/20`}>
